...
an [issue](https://github.com/conan-io/conan-docker-tools/issues/303#issuecomment-922492130) with an undefined symbol when run in some Linux virtual environments, but makes
