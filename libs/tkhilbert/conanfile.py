...
class TkhilbertConan(ConanFile):
    name = "tkhilbert"
    version = "0.1.0"
    license = "Apache 2"
    url = "https://github.com/CQCL/tket"
    description = "Hilbert spaces"
    ...
    def package(self):
        self.copy("include/*.hpp", dst="include/tkhilbert", src="src", keep_path=False)
