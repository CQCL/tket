...
class TestTkhilbertConan(ConanFile):
    name = "test-tkhilbert"
    version = "0.1.0"
    license = "Apache 2"
    ...
    generators = "cmake"
    exports_sources = "*"
    requires = ["tkhilbert/0.1.0", "catch2/3.0.1"]
    ...
    def configure(self):
        if self.options.with_coverage:
            self.options["tkhilbert"].profile_coverage = True
    ...
    def package(self):
        executable_filename = "bin/test-tkhilbert"
