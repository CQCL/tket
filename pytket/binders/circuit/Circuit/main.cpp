      ...
      .def_property_readonly(
          ...
          [](Circuit &circ) {
            ...
            BGL_FORALL_EDGES(e, circ.dag, DAG) {
              ...
              // with pybind11 on mac0S 11 only, that causes the python sided Enum
              // class to take nonsensical values
              std::string edge_type_str = (edge_type == EdgeType::Quantum) ? "Quantum"
