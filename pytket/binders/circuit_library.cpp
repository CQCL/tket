...
auto wrap(Circuit (*wrappedFunc)(
    const SymEngine::Expression&, const SymEngine::Expression&)) {
  return [=](const ExprVariant& arg0, const ExprVariant& arg1) {
    return wrappedFunc(
        convertVariantToFirstType(arg0), convertVariantToFirstType(arg1));
  };
}
auto wrap(Circuit (*wrappedFunc)(
    const SymEngine::Expression&, const SymEngine::Expression&,
  ...
  return [=](const ExprVariant& arg0, const ExprVariant& arg1,
             const ExprVariant& arg2) {
    return wrappedFunc(
        convertVariantToFirstType(arg0), convertVariantToFirstType(arg1),
        convertVariantToFirstType(arg2));
  };
}
auto wrap(Circuit (*wrappedFunc)(
    unsigned, const SymEngine::Expression&, const SymEngine::Expression&)) {
  return
      [=](unsigned intpar, const ExprVariant& arg0, const ExprVariant& arg1) {
        return wrappedFunc(
            intpar, convertVariantToFirstType(arg0),
            convertVariantToFirstType(arg1));
      };
}
auto wrap(const Circuit& (*wrappedFunc)()) { return wrappedFunc; }
auto wrap(Circuit (*wrappedFunc)()) { return wrappedFunc; }
...
PYBIND11_MODULE(circuit_library, library_m) {
  ...
  library_m.def(
      "_CX_XC_reduced", wrap(&CircPool::CX_XC_reduced),
  ...
  library_m.def(
      "_ladder_down", wrap(&CircPool::ladder_down),
  ...
  library_m.def(
      "_BRIDGE", wrap(&CircPool::BRIDGE), "Just a BRIDGE[0,1,2] gate");
  ...
  library_m.def(
      ...
      wrap(&CircPool::TK2_using_ZZPhase_and_swap),
  ...
  library_m.def(
      ...
      wrap(&CircPool::approx_TK2_using_1xZZPhase),
  ...
  library_m.def(
      ...
      wrap(&CircPool::approx_TK2_using_2xZZPhase),
