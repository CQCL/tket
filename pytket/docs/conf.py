...
custom_internal_mapping = {
    ...
    "tket::CompositeGate": "pytket._tket.circuit.CustomGate",
    "tket::Pauli": "pytket._tket.circuit.Pauli",
}
...
def correct_signature(
    ...
    # The "autodoc-process-signature" event is emitted when autodoc has formatted a
    # signature for an object. This event precedes the creation of the doctree
    # (i.e. docutils.document). It's best to correct any wrong types here because some types
    # won't be correctly converted to a docutils.node.
    # For example, "Dict[tket::Architecture, any]" will be converted to "Dict[tket::Architecture, any]"
    # instead of the correct structure "Dict, [, tket::Architecture, any, ]", this breaks all nested references.
