...
class Architecture:
    ...
    def __init__(
        self,
        connections: List[Tuple[pytket._tket.unit_id.Node, pytket._tket.unit_id.Node]],
    ) -> None: ...
    @classmethod
    def from_dict(cls, arg0: dict) -> Architecture: ...
    def get_adjacent_nodes(
        self, node: pytket._tket.unit_id.Node
    ) -> set[pytket._tket.unit_id.Node]: ...
    def get_distance(
        self, node_0: pytket._tket.unit_id.Node, node_1: pytket._tket.unit_id.Node
    ) -> int: ...
    ...
    def coupling(
        self,
    ) -> List[Tuple[pytket._tket.unit_id.Node, pytket._tket.unit_id.Node]]: ...
    @property
...
class SquareGrid(Architecture):
    ...
    @overload
    def __init__(
        self, n_rows: int, n_columns: int, n_layers: int = ..., label: str = ...
    ) -> None: ...
