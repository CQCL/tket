...
class PhasePolyBox(Op):
    @overload
    def __init__(self, n_qubits: int, qubit_indices: Dict[pytket._tket.unit_id.Qubit,int], phase_polynomial: Dict[List[bool],sympy.Expr], linear_transformation: NDArray[numpy.bool_]) -> None: ...
    @overload
