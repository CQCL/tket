...
class CustomGateDef:
    def __init__(self, arg0: str, arg1: Circuit, arg2: List[Symbol]) -> None: ...
    @classmethod
    def define(cls, name: str, circ: Circuit, args: List[Symbol]) -> CustomGateDef: ...
    @classmethod
...
class Op:
    ...
    @overload
    @classmethod
    def create(cls, arg0: OpType, arg1: Expression) -> Op: ...
    @overload
    @classmethod
    def create(cls, arg0: OpType, arg1: List[Expression]) -> Op: ...
    def free_symbols(self) -> set[Symbol]: ...
...
class PauliExpBox(Op):
    def __init__(self, paulis: List[pytket._tket.pauli.Pauli], t: Expression, cx_config_type: CXConfigType = ...) -> None: ...
    def get_circuit(self) -> Circuit: ...
...
class PauliExpCommutingSetBox(Op):
    def __init__(self, pauli_gadgets: List[Tuple[List[pytket._tket.pauli.Pauli],Expression]], cx_config_type: CXConfigType = ...) -> None: ...
    def get_circuit(self) -> Circuit: ...
    def get_cx_config(self) -> CXConfigType: ...
    def get_paulis(self) -> List[Tuple[List[pytket._tket.pauli.Pauli],Expression]]: ...

class PauliExpPairBox(Op):
    def __init__(self, paulis0: List[pytket._tket.pauli.Pauli], t0: Expression, paulis1: List[pytket._tket.pauli.Pauli], t1: Expression, cx_config_type: CXConfigType = ...) -> None: ...
    def get_circuit(self) -> Circuit: ...
    def get_cx_config(self) -> CXConfigType: ...
...
class PhasePolyBox(Op):
    @overload
    def __init__(self, n_qubits: int, qubit_indices: Dict[Qubit,int], phase_polynomial: Dict[List[bool],Expression], linear_transformation: npt.NDArray[numpy.bool_]) -> None: ...
    @overload
