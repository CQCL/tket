...
class Circuit:
    ...
    @overload
    def add_conditional_barrier(self, barrier_args: List[pytket._tket.unit_id.UnitID], condition_bits: List[pytket._tket.unit_id.UnitID], value: int, data: str = ...) -> Circuit: ...
