...
class MeasurementBitMap:
    def __init__(
        self, circ_index: int, bits: List[int], invert: bool = ...
    ) -> None: ...
    @classmethod
...
class MeasurementSetup:
    ...
    def add_result_for_term(
        self, term: pytket._tket.pauli.QubitPauliString, result: MeasurementBitMap
    ) -> None: ...
    @classmethod
    ...
    def results(
        self,
    ) -> Dict[pytket._tket.pauli.QubitPauliString, List[MeasurementBitMap]]: ...
...
def measurement_reduction(
    strings: List[pytket._tket.pauli.QubitPauliString],
    strat: PauliPartitionStrat,
    method: GraphColourMethod = ...,
...
def term_sequence(
    ...
    strat: PauliPartitionStrat = ...,
    method: GraphColourMethod = ...,
) -> List[List[pytket._tket.pauli.QubitPauliString]]: ...
