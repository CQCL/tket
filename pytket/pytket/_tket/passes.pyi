...
from .type_helpers import json, Expression
Audit: SafetyMode
Default: SafetyMode
...
class BasePass:
    ...
    @overload
    def apply(self, compilation_unit, safety_mode: SafetyMode = ...) -> bool: ...
    @overload
    def apply(self, circuit: pytket._tket.circuit.Circuit) -> bool: ...
    @overload
    def apply(self, circuit: pytket._tket.circuit.Circuit, before_apply, after_apply) -> bool: ...
    @classmethod
    def from_dict(cls, arg0: json) -> BasePass: ...
...
def ContextSimp(allow_classical: bool = ..., xcirc: pytket._tket.circuit.Circuit = ...) -> BasePass: ...
...
@overload
def RebaseCustom(gateset: set[pytket._tket.circuit.OpType], cx_replacement: pytket._tket.circuit.Circuit, tk1_replacement: Callable[[Expression,Expression,Expression],pytket._tket.circuit.Circuit]) -> BasePass: ...
@overload
def RebaseCustom(arg0: set[pytket._tket.circuit.OpType], arg1: Callable[[Expression,Expression,Expression],pytket._tket.circuit.Circuit], arg2: Callable[[Expression,Expression,Expression],pytket._tket.circuit.Circuit]) -> BasePass: ...
...
def RenameQubitsPass(qubit_map: Dict[pytket._tket.circuit.Qubit,pytket._tket.circuit.Qubit]) -> BasePass: ...
...
def SquashCustom(singleqs: set[pytket._tket.circuit.OpType], tk1_replacement: Callable[[Expression,Expression,Expression],pytket._tket.circuit.Circuit]) -> BasePass: ...
