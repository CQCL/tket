...
def SquashCustom(singleqs: set[pytket._tket.circuit.OpType], tk1_replacement: Callable[[sympy.Expr,sympy.Expr,sympy.Expr],pytket._tket.circuit.Circuit], always_squash_symbols: bool = ...) -> BasePass: ...
