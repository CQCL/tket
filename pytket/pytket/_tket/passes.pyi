...
class BasePass:
    ...
    @overload
    def apply(self, circuit: pytket._tket.circuit.Circuit, before_apply: Callable[[pytket._tket.predicates.CompilationUnit,json],None], after_apply: Callable[[pytket._tket.predicates.CompilationUnit,json],None]) -> bool: ...
    @classmethod
...
@overload
def RebaseCustom(gateset: set[pytket._tket.circuit.OpType], cx_replacement: pytket._tket.circuit.Circuit, tk1_replacement: Callable[[sympy.Expr,sympy.Expr,sympy.Expr],pytket._tket.circuit.Circuit]) -> BasePass: ...
@overload
def RebaseCustom(arg0: set[pytket._tket.circuit.OpType], arg1: Callable[[sympy.Expr,sympy.Expr,sympy.Expr],pytket._tket.circuit.Circuit], arg2: Callable[[sympy.Expr,sympy.Expr,sympy.Expr],pytket._tket.circuit.Circuit]) -> BasePass: ...
...
def SquashCustom(singleqs: set[pytket._tket.circuit.OpType], tk1_replacement: Callable[[sympy.Expr,sympy.Expr,sympy.Expr],pytket._tket.circuit.Circuit]) -> BasePass: ...
