...
class QubitPauliString:
    ...
    @overload
    def __init__(
        self, qubits: List[pytket._tket.unit_id.Qubit], paulis: List[Pauli]
    ) -> None: ...
    @overload
    ...
    @overload
    def dot_state(
        self, state: NDArray[numpy.complex128]
    ) -> NDArray[numpy.complex128]: ...
    @overload
    def dot_state(
        self, state: NDArray[numpy.complex128], qubits: List[pytket._tket.unit_id.Qubit]
    ) -> NDArray[numpy.complex128]: ...
    @classmethod
    ...
    @overload
    def to_sparse_matrix(
        self, qubits: List[pytket._tket.unit_id.Qubit]
    ) -> scipy.sparse.csc_matrix[numpy.complex128]: ...
    def __eq__(self, arg0: object) -> bool: ...
...
def pauli_string_mult(
    qubitpaulistring1: QubitPauliString, qubitpaulistring2: QubitPauliString
) -> Tuple[QubitPauliString, complex]: ...
