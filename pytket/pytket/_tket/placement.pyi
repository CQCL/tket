...
class Placement:
    ...
    def from_dict(arg0: dict) -> Placement:
        ...
        """
    @staticmethod
    def place_with_map(circuit: ..., qmap: dict[pytket._tket.unit_id.Qubit, pytket._tket.unit_id.Node]) -> bool:
        """
    ...
    def __repr__(self) -> str:
        ...
    def get_placement_map(self, circuit: ...) -> dict[pytket._tket.unit_id.Qubit, pytket._tket.unit_id.Node]:
        """
        ...
        """
    def get_placement_maps(self, circuit: ..., matches: int = 100) -> list[dict[pytket._tket.unit_id.Qubit, pytket._tket.unit_id.Node]]:
        """
    ...
    def to_dict(self) -> typing.Any:
        ...
        """
def place_fully_connected(circuit: ..., fully_connected: pytket._tket.architecture.FullyConnected) -> None:
    """
    ...
    """
def place_with_map(circuit: ..., qmap: dict[pytket._tket.unit_id.Qubit, pytket._tket.unit_id.Node]) -> None:
    """
