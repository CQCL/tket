...
class Transform:
    def __init__(
        self, arg0: Callable[[pytket._tket.circuit.Circuit], bool]
    ) -> None: ...
    @classmethod
    def CnXPairwiseDecomposition(cls) -> Transform: ...
    @overload
    @classmethod
    def CommuteSQThroughSWAP(
        cls, avg_node_errors: Dict[pytket._tket.unit_id.Node, float]
    ) -> Transform: ...
    @overload
    @classmethod
    def CommuteSQThroughSWAP(
        cls,
        op_node_errors: Dict[
            pytket._tket.unit_id.Node, Dict[pytket._tket.circuit.OpType, float]
        ],
    ) -> Transform: ...
    @classmethod
    ...
    @classmethod
    def DecomposeCXDirected(
        cls, arc: pytket._tket.architecture.Architecture
    ) -> Transform: ...
    @classmethod
    ...
    @classmethod
    def OptimisePauliGadgets(
        cls, cx_config: pytket._tket.circuit.CXConfigType = ...
    ) -> Transform: ...
    @classmethod
    ...
    @classmethod
    def SynthesisePauliGraph(
        cls,
        synth_strat: PauliSynthStrat = ...,
        cx_config: pytket._tket.circuit.CXConfigType = ...,
    ) -> Transform: ...
    @classmethod
    def ThreeQubitSquash(
        cls, target_2qb_gate: pytket._tket.circuit.OpType = ...
    ) -> Transform: ...
    @classmethod
    def UCCSynthesis(
        cls,
...
def separate_classical(
    circ: pytket._tket.circuit.Circuit,
) -> Tuple[pytket._tket.circuit.Circuit, pytket._tket.circuit.Circuit]: ...
