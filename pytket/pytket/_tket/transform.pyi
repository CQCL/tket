...
class Transform:
    ...
    @overload
    @classmethod
    def CommuteSQThroughSWAP(cls, avg_node_errors: Dict[pytket._tket.circuit.Node,float]) -> Transform: ...
    @overload
    @classmethod
    def CommuteSQThroughSWAP(cls, op_node_errors: Dict[pytket._tket.circuit.Node,Dict[pytket._tket.circuit.OpType,float]]) -> Transform: ...
    @classmethod
    ...
    @classmethod
    def DecomposeSWAPtoCX(cls, arc: pytket._tket.architecture.Architecture = ..., nodes = ...) -> Transform: ...
    @classmethod
