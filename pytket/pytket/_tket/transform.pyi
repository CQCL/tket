...
class Transform:
    ...
    def DecomposeBRIDGE() -> Transform:
        ...
        """
    @staticmethod
    def DecomposeBoxes(excluded_types: set[pytket._tket.circuit.OpType] = set(), excluded_opgroups: set[str] = set(), included_types: set[pytket._tket.circuit.OpType] | None = None, included_opgroups: set[str] | None = None) -> Transform:
        """
