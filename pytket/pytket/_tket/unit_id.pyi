...
class Bit(UnitID):
    ...
    def from_list(arg0: list) -> Bit:
        ...
        """
    def __and__(self, other: typing.Union[pytket.circuit.logic_exp.BitLogicExp, pytket._tket.unit_id.Bit, int]) -> pytket.circuit.logic_exp.BitLogicExp:
        ...
    ...
    def __init__(self, name: str, index: typing.Sequence[int]) -> None:
        ...
        """
    def __or__(self, other: typing.Union[pytket.circuit.logic_exp.BitLogicExp, pytket._tket.unit_id.Bit, int]) -> pytket.circuit.logic_exp.BitLogicExp:
        ...
    def __rand__(self, other: typing.Union[pytket.circuit.logic_exp.BitLogicExp, pytket._tket.unit_id.Bit, int]) -> pytket.circuit.logic_exp.BitLogicExp:
        ...
    def __ror__(self, other: typing.Union[pytket.circuit.logic_exp.BitLogicExp, pytket._tket.unit_id.Bit, int]) -> pytket.circuit.logic_exp.BitLogicExp:
        ...
    def __rxor__(self, other: typing.Union[pytket.circuit.logic_exp.BitLogicExp, pytket._tket.unit_id.Bit, int]) -> pytket.circuit.logic_exp.BitLogicExp:
        ...
    def __xor__(self, other: typing.Union[pytket.circuit.logic_exp.BitLogicExp, pytket._tket.unit_id.Bit, int]) -> pytket.circuit.logic_exp.BitLogicExp:
        ...
...
class BitRegister:
    ...
    """
    def __add__(self, other: typing.Union[pytket.circuit.logic_exp.RegLogicExp, pytket._tket.unit_id.BitRegister, int]) -> pytket.circuit.logic_exp.RegLogicExp:
        ...
    def __and__(self, other: typing.Union[pytket.circuit.logic_exp.RegLogicExp, pytket._tket.unit_id.BitRegister, int]) -> pytket.circuit.logic_exp.RegLogicExp:
        ...
    ...
    def __eq__(self, arg0: typing.Any) -> bool:
        ...
    def __floordiv__(self, other: typing.Union[pytket.circuit.logic_exp.RegLogicExp, pytket._tket.unit_id.BitRegister, int]) -> pytket.circuit.logic_exp.RegLogicExp:
        ...
    ...
    def __or__(self, other: typing.Union[pytket.circuit.logic_exp.RegLogicExp, pytket._tket.unit_id.BitRegister, int]) -> pytket.circuit.logic_exp.RegLogicExp:
        ...
    def __pow__(self, other: typing.Union[pytket.circuit.logic_exp.RegLogicExp, pytket._tket.unit_id.BitRegister, int]) -> pytket.circuit.logic_exp.RegLogicExp:
        ...
    def __rand__(self, other: typing.Union[pytket.circuit.logic_exp.RegLogicExp, pytket._tket.unit_id.BitRegister, int]) -> pytket.circuit.logic_exp.RegLogicExp:
        ...
    def __repr__(self) -> str:
        ...
    def __ror__(self, other: typing.Union[pytket.circuit.logic_exp.RegLogicExp, pytket._tket.unit_id.BitRegister, int]) -> pytket.circuit.logic_exp.RegLogicExp:
        ...
    def __rshift__(self, other: typing.Union[pytket.circuit.logic_exp.RegLogicExp, pytket._tket.unit_id.BitRegister, int]) -> pytket.circuit.logic_exp.RegLogicExp:
        ...
    def __rxor__(self, other: typing.Union[pytket.circuit.logic_exp.RegLogicExp, pytket._tket.unit_id.BitRegister, int]) -> pytket.circuit.logic_exp.RegLogicExp:
        ...
    def __str__(self) -> str:
        ...
    def __sub__(self, other: typing.Union[pytket.circuit.logic_exp.RegLogicExp, pytket._tket.unit_id.BitRegister, int]) -> pytket.circuit.logic_exp.RegLogicExp:
        ...
