...
class CliffordGen(ZXGen):
    def __init__(
        self, zxtype: ZXType, param: bool = ..., qtype: QuantumType = ...
    ) -> None: ...
    @property
    def param(self) -> bool: ...
...
class ZXDiagram:
    ...
    @overload
    def __init__(
        self, inputs: int, outputs: int, classical_inputs: int, classical_outputs: int
    ) -> None: ...
    @overload
    ...
    @overload
    def add_vertex(
        self, type: ZXType, param: bool, qtype: QuantumType = ...
    ) -> ZXVert: ...
    @overload
    def add_vertex(
        self, type: ZXType, param: Union[sympy.Expr, float], qtype: QuantumType = ...
    ) -> ZXVert: ...
    def add_wire(
        self,
        u: ZXVert,
    ...
    def get_boundary(
        self, type: Optional[ZXType] = ..., qtype: Optional[QuantumType] = ...
    ) -> List[ZXVert]: ...
    ...
    def get_wire_ends(
        self, w: ZXWire
    ) -> Tuple[Tuple[ZXVert, Optional[int]], Tuple[ZXVert, Optional[int]]]: ...
    ...
    def to_circuit(
        ...
        pytket._tket.circuit.Circuit, Dict[ZXVert, pytket._tket.unit_id.UnitID]
    ]: ...
...
class ZXGen:
    ...
    @classmethod
    def create(
        cls, type: ZXType, param: Union[sympy.Expr, float], qtype: QuantumType = ...
    ) -> ZXGen: ...
...
def circuit_to_zx(
    arg0: pytket._tket.circuit.Circuit,
) -> Tuple[ZXDiagram, Dict[pytket._tket.unit_id.UnitID, Tuple[ZXVert, ZXVert]]]: ...
