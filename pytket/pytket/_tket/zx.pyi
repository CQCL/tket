...
from scipy import Symbol
from typing import overload
from type_helpers import Expression
...
class PhasedGen(ZXGen):
    def __init__(self, zxtype: ZXType, param: Expression = ..., qtype: QuantumType = ...) -> None: ...
    @property
...
class ZXDiagram:
    ...
    @overload
    def add_vertex(self, type: ZXType, param: Expression, qtype: QuantumType = ...) -> ZXVert: ...
    ...
    def multiply_scalar(self, scalar: Expression) -> None: ...
    ...
    def to_circuit(self) -> Tuple[pytket._tket.circuit.Circuit,Dict[ZXVert,pytket._tket.circuit.UnitID]]: ...
...
class ZXGen:
    ...
    @overload
    @classmethod
    def create(cls, type: ZXType, param: Expression, qtype: QuantumType = ...) -> ZXGen: ...
    def __eq__(self, arg0: ZXGen) -> bool: ...
    @property
...
class ZXVert:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __eq__(self, arg0: ZXVert) -> bool: ...
    def __hash__(self) -> int: ...

class ZXWire:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __eq__(self, arg0: ZXWire) -> bool: ...
    def __hash__(self) -> int: ...
...
def circuit_to_zx(arg0: pytket._tket.circuit.Circuit) -> Tuple[ZXDiagram,Dict[pytket._tket.circuit.UnitID,Tuple[ZXVert,ZXVert]]]: ...
