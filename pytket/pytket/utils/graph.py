...
class Graph:
    def __init__(self, c: Circuit):
        ...
        self.edge_data: dict[tuple[int, int], list[tuple[int, int, EdgeType]]] = defaultdict(list)
    ...
    def get_DAG(self) -> gv.Digraph:
        ...
        edge_colors = {
            EdgeType.Quantum.value: q_color,
            EdgeType.Boolean.value: b_color,
            EdgeType.Classical.value: c_color,
            EdgeType.WASM.value: w_color,
        }
        edge_attr = {
            "weight": "2",
            "arrowhead": "vee",
