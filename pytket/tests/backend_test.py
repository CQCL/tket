...
from pytket.mapping import MappingManager, LexiRouteRoutingMethod, LabellingRoutingMethod  # type: ignore
...
def test_postprocess_3() -> None:
    ...
    rc = c.copy()
    mm.route_circuit(rc, [LabellingRoutingMethod(), LexiRouteRoutingMethod()])
    n_shots = 100
