...
const std::map<OpType, OpTypeInfo>& optypeinfo() {
  ...
  static const std::map<OpType, OpTypeInfo> typeinfo{
      ...
      {OpType::WASMInput,
       {"WASMInput", "WASM IN", {}, op_signature_t({EdgeType::WASM})}},
      {OpType::WASMOutput,
       {"WSAMOutput", "WSAM OUT", {}, op_signature_t({EdgeType::WASM})}},
      ...
      {OpType::WASM,
       {"WASM",
        "WASM",
        {},
        std::nullopt}},  // {OpType::WASM, {"WASM", "WASM", {},
                         // op_signature_t({EdgeType::Classical,
                         // EdgeType::WASM})}},
