...
WASMOp::WASMOp(
  ...
  unsigned sum_of_i32 =
      std::accumulate(
          width_i_parameter_.begin(), width_i_parameter_.end(),
          decltype(width_i_parameter_)::value_type(0)) +
      std::accumulate(
          width_o_parameter_.begin(), width_o_parameter_.end(),
          decltype(width_o_parameter_)::value_type(0));
