...
SCENARIO("Simplify to a graph-like diagram") {
  GIVEN("A manually-constructed diagram") {
    ...
    diag1.add_wire(diag1_inputs[0], zSpid1);
    diag1.add_wire(zSpid1, phZSpid1);
    diag1.add_wire(phZSpid1, zSpid2);
    diag1.add_wire(zSpid2, diag1_outputs[0], ZXWireType::H);
    diag1.add_wire(zSpid1, xSpid1);
    diag1.add_wire(zSpid2, xSpid2);
    diag1.add_wire(diag1_inputs[1], xSpid1, ZXWireType::H);
    diag1.add_wire(xSpid1, zSpid3);
    diag1.add_wire(zSpid3, xSpid2);
    diag1.add_wire(xSpid2, phZSpid2);
    diag1.add_wire(phZSpid2, diag1_outputs[1]);
    diag1.add_wire(zSpid3, xSpid3);
    diag1.add_wire(diag1_inputs[2], xSpid3, ZXWireType::H);
    diag1.add_wire(xSpid3, diag1_outputs[2]);
    diag1.add_wire(diag1_inputs[3], diag1_outputs[3], ZXWireType::H);
...
SCENARIO("Testing Spider fusion") {
  GIVEN("A manually-constructed diagram") {
    ...
    diag2.add_wire(diag2_inputs[1], spid5, ZXWireType::H, QuantumType::Quantum);
  ...
  GIVEN("A scalar diagram") {
    ...
    diag3.add_wire(v1, v4, ZXWireType::H);
    diag3.add_wire(v4, v5, ZXWireType::Basic);
    diag3.add_wire(v5, v4, ZXWireType::H);
    diag3.add_wire(v5, v6, ZXWireType::Basic);
    diag3.add_wire(v6, v3, ZXWireType::H);
    diag3.add_wire(v3, v2, ZXWireType::Basic);
    diag3.add_wire(v2, v3, ZXWireType::H);
    diag3.add_wire(v2, v1, ZXWireType::Basic);
