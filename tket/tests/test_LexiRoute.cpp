...
SCENARIO("ASDFSD") {
  GIVEN("Ancilla assignment, one valid node.") {
    ...
    std::cout << "solve labelling" << std::endl;
    LexiRoute lr1(shared_arc, mf);
...
//   }
//   GIVEN("No qubit to label, partially filled frontier, routing_method
//   false.") {
//     Circuit circ(5);
//     std::vector<Qubit> qubits = circ.all_qubits();
//     circ.add_op<UnitID>(OpType::CX, {qubits[0], qubits[4]});
...
//   }
//   GIVEN(
//       "One unlabelled qubit, two slices, lookahead for better solution,
//       check" " and route.") {
//     Circuit circ(5);
//     std::vector<Qubit> qubits = circ.all_qubits();
//     circ.add_op<UnitID>(OpType::CX, {qubits[0], qubits[1]});
...
//          {nodes[3], nodes[10]}});
//     ArchitecturePtr shared_arc =
//     std::make_shared<Architecture>(architecture); Circuit circ(11);
//     std::vector<Qubit> qubits = circ.all_qubits();
...
//     // transform stuff
//     PassPtr dec = gen_decompose_routing_gates_to_cxs_pass(architecture,
//     false);
...
//     PredicatePtr routed_correctly =
//     std::make_shared<ConnectivityPredicate>(sg); PredicatePtrMap
//     preds{CompilationUnit::make_type_pair(routed_correctly)}; CompilationUnit
//     cu(circ, preds); dec->apply(cu); REQUIRE(res);
...
//     add_2qb_gates(test_circuit, OpType::CX, {{0, 1}, {1, 2}, {2, 3}, {3,
//     0}});
...
//          {7, 8},   {8, 12},  {8, 13},  {8, 9},   {10, 11}, {11, 16}, {11,
//          17}, {11, 12}, {12, 16}, {12, 17}, {12, 13}, {13, 18}, {13, 19},
//          {13, 14}, {14, 18}, {14, 19}, {15, 16}, {16, 17}, {17, 18}, {18,
//          19}});
//     MappingManager mm(std::make_shared<Architecture>(arc));
//     REQUIRE(mm.route_circuit(
//         circ, {std::make_shared<LexiLabellingMethod>(),
//                std::make_shared<LexiRouteRoutingMethod>()}));
//     (Transforms::decompose_SWAP_to_CX() >>
...
//     circ.add_op<UnitID>(OpType::SWAP, {qubits_renamed[1],
//     qubits_renamed[4]}); circ.add_op<UnitID>(OpType::SWAP,
//     {qubits_renamed[3], qubits_renamed[4]});
//     circ.add_op<UnitID>(OpType::SWAP, {qubits_renamed[1],
//     qubits_renamed[2]});
...
//     circ.add_op<UnitID>(OpType::SWAP, {qubits_renamed[2],
//     qubits_renamed[5]}); circ.add_op<UnitID>(OpType::SWAP,
//     {qubits_renamed[3], qubits_renamed[4]});
//     circ.add_op<UnitID>(OpType::SWAP, {qubits_renamed[1],
//     qubits_renamed[2]});
...
//     circ.add_op<UnitID>(OpType::SWAP, {qubits_renamed[1],
//     qubits_renamed[2]}); circ.add_op<UnitID>(OpType::SWAP,
//     {qubits_renamed[4], qubits_renamed[5]});
//     circ.add_op<UnitID>(OpType::SWAP, {qubits_renamed[1],
//     qubits_renamed[4]}); circ.add_op<UnitID>(OpType::SWAP,
//     {qubits_renamed[1], qubits_renamed[3]});
//     circ.add_op<UnitID>(OpType::SWAP, {qubits_renamed[2],
//     qubits_renamed[5]}); circ.add_op<UnitID>(OpType::SWAP,
//     {qubits_renamed[1], qubits_renamed[2]});
//     circ.add_op<UnitID>(OpType::SWAP, {qubits_renamed[3],
//     qubits_renamed[4]});
...
//     PassPtr plac_p =
//     gen_placement_pass(std::make_shared<GraphPlacement>(arc));
...
//                     {5, 8},   {6, 7},   {7, 10},  {8, 9},   {8, 11},  {10,
//                     12}, {11, 14}, {12, 13}, {14, 13}, {14, 16}, {12, 15},
//                     {15, 18}, {17, 18}, {16, 19}, {19, 20}, {18, 21}, {21,
//                     23}, {19, 22}, {22, 25}, {23, 24}, {24, 25}, {25, 26}});
